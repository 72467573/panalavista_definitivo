    ...
    return Scaffold(
        ...
        body: Container(
          ...
          Botoncitos(
              subtitle2: 'Lampa',
              subtitle: 'Distrito',
              icono: Icon(Icons.group_remove_rounded,
                  color: Color.fromARGB(255, 136, 59, 0), size: 50),
              titulo: IconButton(
                onPressed: null,
                icon: Icon(null),
              )),
    ...
    return SizedBox(
        ...
        child: ListTile(
          ...
          title: Container(
            child: Row(children: [
              Container(
                margin: const EdgeInsets.only(bottom: 0, right: 28, top: 0),
                child: icono,
              ),
              Column(
                children: [
              ...
              Container(
                margin: const EdgeInsets.only(bottom: 50, left: 0, top: 0),
                child: titulo,
              )
